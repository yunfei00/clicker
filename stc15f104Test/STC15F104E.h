...
/*
 * Minimal SDCC-compatible STC15F104E register declarations used by this
 * project.  SDCC requires address-qualified declarations (for example
 * __sfr __at (0xB0) P3) instead of Keil C51's "sfr P3 = 0xB0" syntax.
 */
